using UnityEngine;
	...
	public class MovementSettings
	{
		...
		public float JumpforwardPower;
				public float MaxHorizontal = 8.0f; // In meters/second
...
public Transform CamTarget;
		...
		public  void Init()
		{
			...
			if(!_playerCamera){
           GameObject Cam =  Instantiate(CamObject, transform.position, Quaternion.identity);
                _playerCamera = Cam.GetComponent<PlayerCamera>();
			}
					}
		}
		...
		{
			_playerCamera.SetPosition(CamTarget.position);
			_playerCamera.SetControlRotation(GetControlRotation());
		}
		...
		private Vector3 GetMovementInput()
		{
			...
			Quaternion yawRotation = Quaternion.Euler(0.0f, GetControlRotation().y, 0.0f);
